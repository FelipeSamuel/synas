  ...
  return (
    <MainContainer>
      ...
      <TermsText>
        ...
        Centro, na Cidade e Estado do Rio de Janeiro, detentora de seus direitos
        autorais.
        <br />
        ...
        REFLETIR EVENTUAIS ALTERAÇÕES NECESSÁRIAS. EVENTUAIS VERSÕES ATUALIZADAS
        SERÃO PUBLICADAS NO MESMO SITE INDICADO ACIMA, QUE DEVERÁ SER CONSULTADO
        REGULARMENTE.
        <br />
        ...
        sexo; (iii) endereço de e-mail pessoal válido (login) que seja acessado
        regularmente; (iv) data, local e horário de nascimento. Em seguida,
        deverá criar uma senha pessoal e intransferível.
        <br />
        • O USUÁRIO DECLARA ESTAR CIENTE DE QUE SEU SIGNO, ASCENDENTE E
        ELEMENTOS INFLUENCIADORES COMO A LUA, SATURNO, NETUNO, VÊNUS, MERCÚRIO,
        MARTE, JÚPITER, PLUTÃO, URANO E SUAS RESPECTIVAS CASAS PODERÃO SER
        DISPONIBILIZADOS AOS OUTROS USUÁRIOS DO SYNAS, IDENTIFICADOS COMO
        COMPATÍVEIS, E VICE-VERSA, PARA QUE POSSAM DECIDIR SE DESEJAM OU NÃO
        INICIAR UM RELACIONAMENTO.
        <br />
        • EM QUE PESE O SYNAS SE UTILIZAR DE INFORMAÇÕES FORNECIDAS PELO MAPA
        ASTRAL DE SEUS USUÁRIOS, ELABORADO A PARTIR DOS DADOS DE SEU CADASTRO, O
        USUÁRIO DECLARA E RECONHECE QUE A DISPONIBILIZAÇÃO DO REFERIDO MAPA
        ...
        formalidade.
        <br />
        • A pessoa física que deseja utilizar os serviços disponibilizados pelo
        Synas deverá ser civilmente capaz, nos moldes da legislação civil
        vigente no Brasil, para que possa figurar como Usuário. No caso de
        qualquer eventual cadastro de Usuário absoluta ou relativamente incapaz
        (por exemplo, menores de 18 anos de idade), com ou sem permissão de seus
        pais, tutores ou representantes legais, estes serão responsáveis por
        todos os atos praticados pelo menor, na forma da lei.
        <br />
        ...
        aposição de senha que é de seu conhecimento exclusivo. Nesse sentido, o
        Usuário reconhece que:
        <br />
        • desde o primeiro acesso, estará concordando com os presentes Termos e
        Condições de Uso e a Política de Privacidade e Proteção de Dados do
        Synas;
        <br />
        ...
        contato disponibilizada no aplicativo, sobre qualquer uso ou acesso não
        ...
        conforme disposto na Seção 4.1 deste documento. A liberação do acesso ao
        conteúdo dos Serviços Premium está condicionada à confirmação de
        pagamento.
        <br />
        • CADASTRO E CANCELAMENTO
        <br />
        • Ao efetuar o seu cadastro e aceitar o presente instrumento, o Usuário
        reconhece que, no momento, somente a versão gratuita do serviço está
        disponível para acesso ao público.
        <br />
        ...
        • CONFIDENCIALIDADE
        <br />
        • A Sociedade se compromete a manter a confidencialidade, integridade e
        segurança de quaisquer Informações disponibilizadas pelo Usuário ou a
        ele relacionadas.
        <br />
        ...
        segurança de suas informações, a Sociedade se compromete a regularmente
        reavaliar a sua política de segurança e adaptá-la, conforme necessário.
        <br />
        ...
        autoral, informações sobre ferramentas de software, designs de hardware,
        algoritmos, design de interface de usuário, documentação em qualquer
        formato, técnicas e métodos, fórmulas, demonstrações, apresentações,
        relatórios, listas e preços. As Informações Confidenciais incluem todo e
        qualquer conteúdo compartilhado com o Cliente, em virtude das atividades
        exercidas pela Sociedade, e todas as informações fornecidas (seja de
        forma escrita ou oral, direta ou indiretamente) por esta, seus
        representantes, conselheiros, diretores e empregados, sejam antes ou
        depois da data de anuência com estes Termos e Condições de Uso e
        marcadas, ou indicadas, como “Confidencial” ou similar, ou cujo
        destinatário entenda, de forma razoável, serem Informações Confidenciais
        ...
        diversos daqueles definidos neste instrumento, sem a devida autorização
        da Parte reveladora.
        <br />
        ...
        de órgão competente fiscalizador das atividades envolvidas por qualquer
        das Partes, sendo, em qualquer dos casos, divulgadas somente nos limites
        ...
        <br />
        • for de domínio público anteriormente à sua divulgação à Sociedade, por
        fontes legítimas diversas do Usuário;
        <br />
        • já for de conhecimento do Usuário no momento em que seja divulgada ao
        mesmo, por fontes legítimas diversas da Sociedade;
        <br />
        ...
        outra fonte que não tenha, direta ou indiretamente, obrigação de sigilo
        com o Usuário;
        <br />
        ...
        notifique com antecedência a Sociedade e seus representantes do pedido,
        além de utilizar esforços comercialmente razoáveis para limitar a
        extensão de tal abertura.
        <br />
        ...
        como de domínio público e são de titularidade exclusiva da Sociedade, de
        seus parceiros ou de terceiros licenciantes, conforme o caso.
        <br />
        ...
        <br />
        • Toda informação ou dado pessoal prestado pelo Usuário à Sociedade para
        utilização do Synas é armazenada em banco de dados próprio, através de
        ...
        prejuízo que possa ser derivado da violação dessas medidas por parte de
        terceiros que utilizem as redes públicas ou a internet, subvertendo os
        sistemas de segurança para acessar as informações de seus Usuários.
        <br />
        • A Sociedade, ao se utilizar de qualquer das informações destes Termos
        e Condições de Uso, não identificará a titularidade dos dados, mantendo
        o anonimato do Usuário.
        <br />
        • Em caso de dúvidas sobre a proteção a dados pessoais ou para obter
        maiores informações sobre dados pessoais e os casos nos quais poderá ser
        quebrado o sigilo de que trata esta Seção, o Usuário deverá consultar a
        Política de Privacidade e Proteção de Dados do Synas, que é parte
        integrante destes Termos e Condições de Uso.
        <br />
        ...
        <br />
        • Uma vez constatado o uso fraudulento do Synas, a Sociedade promoverá a
        exclusão do Usuário do website, nada lhe sendo devido a que título for.
        <br />
        ...
        cadastro;
        <br />
        • utilizar o Synas para divulgar informações de qualquer forma que possa
        implicar em violação de normas aplicáveis no Brasil, de direitos de
        propriedade da Synas e/ou de terceiros ou dos bons costumes, incluindo,
        sem limitação, a violação de direitos intelectuais, autorais e de
        ...
        indevidamente o Synas para práticas nocivas à Sociedade ou a terceiros,
        tais como a prática de fraudes, spamming, flooding e spoofing, etc;
        <br />
        • reproduzir, adaptar, modificar e/ou empregar, no todo ou em parte,
        para qualquer fim, o aplicativo sem a autorização expressa da Sociedade;
        <br />
        • publicar ou transmitir qualquer arquivo que contenha vírus, malwares,
        spywares ou qualquer outro programa contaminante ou destrutivo, ou que
        de outra forma possa interferir no bom funcionamento do Synas; ou
        <br />
        • utilizar o aplicativo para finalidade diversa daquela para a qual foi
        ...
        Sociedade ou em sua conectividade com a internet de modo geral, devendo
        o Usuário manter, às suas expensas, linha de telecomunicação, modem,
        software de comunicação, endereço de correio eletrônico e outros
        recursos necessários para a comunicação com a Sociedade.
        <br />
        • A Sociedade não garante que as funções contidas no Synas atendam às
        suas necessidades, que sua operação será ininterrupta ou livre de erros
        ou que o aplicativo será compatível ou funcione com qualquer outro
        ...
        O TERMO DE USO E/OU USAR O SYNAS, O USUÁRIO ENTENDE E ASSUME
        EXPRESSAMENTE ESSE RISCO E CONCORDA QUE A SOCIEDADE NÃO SERÁ RESPONSÁVEL
        POR TAL TIPO DE VAZAMENTO DE DADOS, DESDE QUE COMPROVADO QUE TODAS AS
        ...
        • DISPOSIÇÕES FINAIS
        <br />
        • Na hipótese de qualquer cláusula, termo ou disposição destes Termos e
        Condições de Uso vir a ser declarada nula ou inexequível, tal nulidade
        ou inexequibilidade não afetará quaisquer outras cláusulas, termos ou
        condições aqui contidos, os quais permanecerão em pleno vigor e efeito.
        <br />
        ...
        <br />
        • A tolerância de uma parte em relação à outra quanto ao descumprimento
        de qualquer uma das obrigações assumidas neste instrumento não implicará
        em novação ou renúncia de direito. A parte tolerante poderá, a qualquer
        tempo, exigir da outra parte o fiel e cabal cumprimento do conteúdo
        previsto.
        <br />
        • O Usuário concorda que a Sociedade possa enviar notificações via
        correio eletrônico sobre parcerias e campanhas relacionadas aos serviços
        disponibilizados pelo Synas.
        <br />
        • LEI E FORO APLICÁVEIS
        <br />
        • Estes Termos e Condições de Uso serão interpretados exclusivamente
        segundo as leis do Brasil.
        <br />• As partes elegem o Foro da Comarca da Capital do Rio de Janeiro
        como o único competente para dirimir qualquer litígio resultante deste
        instrumento.
      </TermsText>
